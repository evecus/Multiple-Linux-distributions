...
echo "Testing for existence ${devtype} ${devnum} ${prefix}bootEnv.txt ..."
if test -e ${devtype} ${devnum} ${prefix}bootEnv.txt; then
	echo "Found ${devtype} ${devnum} ${prefix}bootEnv.txt - loading ${devtype} ${devnum} ${load_addr} ${prefix}bootEnv.txt ..."
	load ${devtype} ${devnum} ${load_addr} ${prefix}bootEnv.txt
	echo "Loaded environment from ${devtype} ${devnum} ${prefix}bootEnv.txt into ${load_addr} filesize ${filesize}..."
	echo "Importing into environment ..."
	env import -t ${load_addr} ${filesize}
	echo "bootEnv.txt imported into environment"
fi
